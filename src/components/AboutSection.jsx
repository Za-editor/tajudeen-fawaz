...
import { SiJavascript, SiReact, SiNodedotjs, SiCss3, SiRedux, SiSass, SiTailwindcss, SiMongodb, SiPostgresql, SiExpress } from "react-icons/si";
...
export default function AboutSection() {
  ...
  useGSAP(() => {
    const ctx = gsap.context(() => {
      ...
      // Sequential panel animation (slide in → pause → slide out)
      panels.forEach((panel) => {
        tl.to(panel, {
          ...
          .to({}, { duration: 0.5 }) // hold in center
          .to(panel, {
            yPercent: -200,
            autoAlpha: 0,
            duration: 0.8,
  ...
  return (
    <section className="container mx-auto py-16 min-h-screen overfloy-y-hidden">
      <div ref={containerRef} className="relative overflow-hidden ">
        ...
        <div className="flex flex-col md:flex-row items-center justify-center px-4 md:px-20 ">
          <div className="w-full md:w-1/2 flex flex-col justify-center text-gray-800 relative">
          ...
          <div className="w-full md:w-1/2 flex items-center justify-center sticky top-0 h-screen">
            <div className="relative flex items-center justify-center">
              <div className="w-48 h-48 md:w-100 md:h-100 rounded-full flex items-center justify-center shadow-inner">
