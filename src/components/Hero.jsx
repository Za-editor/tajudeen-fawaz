...
const Hero = () => {
  ...
  return (
    <div className="min-h-[80vh] container mx-auto flex items-center justify-center relative">
      <div className=" flex justify-center items-center">
        <svg
          className="absolute top-0.5   w-[716px] h-[716px] md:w-[1000px] md:h-[1000px]"
          viewBox="0 0 716 716"
        ...
        <div className="relative z-10 text-center text-[#192f3d]">
          <p className="text-[19px]">Hi, I'm Fawaz Tajudeen</p>
          ...
          <div className="mx-auto mt-5 md:mt-10 relative w-10 h-10 flex items-center justify-center border border-[#192f3d] hover:border-none rounded-full overflow-hidden group cursor-pointer">
      ...
      <div className=" absolute bottom-5 right-0 mx-auto mt-5 md:mt-10  w-10 h-10 flex items-center justify-center border border-[#192f3d] hover:border-none rounded-full overflow-hidden group cursor-pointer">
        <div className="absolute inset-0 bg-[#005764] translate-y-full group-hover:translate-y-0 transition-transform duration-500 ease-in-out [mask-image:radial-gradient(ellipse_at_center,black_70%,transparent_100%)]" />
